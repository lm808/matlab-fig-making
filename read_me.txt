MATLAB figure toolbox for document prepartion.
...
These should be available on most Linux distributions, if not already installed. These are used to trim the outputted figure so that all white margins are removed. If these are missing, fFigCapture.m will throw errors for PDF and PNG outputs, but should not affect the usage of these functions.

---------------------------------------------------------

Usage

1) Install dependencies for your system.
1) Add these functions to your MATLAB path.
